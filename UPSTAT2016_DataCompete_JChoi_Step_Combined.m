...
% 8.0. Smooth Velocity that was previously calculated.
smoothVel_v2a_Out = smoothVel_v2a(filledDataIn, aggDataIn, SpanNumPoints);


% 9.0. Plot Data after Smoothing Velocity
for i=1:totIDIn
    mynumID=i
